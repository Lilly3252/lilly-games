...
export class CommunityCardHandler {
	private communityCards: CommunityCard[]; // An array of community cards
	private players: Monopoly["players"]; // Reference to the players in the Monopoly game
	 ...
	 */
	handleSpendEachPlayer(players: Player[], amount: number): number {
